    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                @if($product->image)
                    <div class="mb-4">
                        <img src="{{ asset('storage/' . $product->image) }}" alt="Current" class="max-w-xs rounded-lg">
                    </div>
                @endif
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-gray-400">
                    ...
                    <label for="image" class="cursor-pointer block">
                        ...
                        <p class="text-gray-600">Click to upload or drag and drop (leave empty to keep current)</p>
